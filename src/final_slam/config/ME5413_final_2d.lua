...
options = {
  ...
  provide_odom_frame = false, -- TF map_frame->odom_frame + odom_frame->published_frame
  publish_frame_projected_to_2d = true, -- 投影到2D，上坡时pitch/roll不泄漏到TF
...
TRAJECTORY_BUILDER_2D.submaps.num_range_data = 200 -- 回到200
...
POSE_GRAPH.optimize_every_n_nodes = 10 -- 5->10 减少全局优化触发频率
